...
//
// 使い方(素の `gh` と同じ引数):
//   node harness/scripts/gh/gh.mjs issue create --title "..." --body "..."
//   node harness/scripts/gh/gh.mjs pr create --base develop --title "..." --body "..."
//   node harness/scripts/gh/gh.mjs pr view 123 --json state,mergedAt
//   echo "body" | node harness/scripts/gh/gh.mjs pr comment 123 --body-file -
//
// 設定は app-token.mjs 参照(BOT_GH_APP_ID / BOT_GH_INSTALLATION_ID /
// BOT_GH_APP_KEY を .claude/settings.local.json の "env" に置く)。
