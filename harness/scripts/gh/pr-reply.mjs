...
//
// 使い方:
//   node harness/scripts/gh/pr-reply.mjs <PR番号> <コメントID> <本文>
//   node harness/scripts/gh/pr-reply.mjs <PR番号> <コメントID> --body-file <path>
//   echo "本文" | node harness/scripts/gh/pr-reply.mjs <PR番号> <コメントID> -
//
...
if (!/^\d+$/.test(prNumber ?? '') || !/^\d+$/.test(commentId ?? '')) {
  console.error('usage: node harness/scripts/gh/pr-reply.mjs <PR番号> <コメントID> <本文 | --body-file path | ->')
  process.exit(2)
}
