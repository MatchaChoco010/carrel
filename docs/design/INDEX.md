...
| [0010](0010_reading_text_in_verification.md) | 変換から文字の読み取りを外し、照合に任せる | reviewing | not-started |
| [0011](0011_parallel_translation.md) | 翻訳を節ごとに並べて走らせる | reviewing | not-started |
